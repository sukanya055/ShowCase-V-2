      ...
      <div>
        <div>
          <div className="flex justify-center items-center ">
            <div
              className={`gap-5 ${
                index === num ? styles.reviewCard : styles.review
              } relative py-5 pl-2 shadow-xl mb-20`}
            >
              <img
                className="h-[170px] mx-auto w-[170px] rounded-full object-cover "
                src={img}
                alt="Shoes"
              />

              <div class="card-body sm:p-2 p-1 items-center text-center">
                <p className="font-bold lg:text-[25px] sm:text-[20px] text-[18px]">
                  {name}
                </p>
